<div class="container-fluid">
	...
	<div class="row" style="font-size: 18px;">
		...
		<div class="col-sm-2 text-right">
			<a href="" title="Back to results" class="btn btn-lg btn-default glyphicon glyphicon-arrow-left"></a>
		</div>
	</div>
		...
		<div class="panel-body">
					<div class="list-group">
						<p class="list-group-item-text">
							<ul class="list-group">
								<li class="list-group-item text-center" style="background: lightgrey;">
							<h4>
						...
						<li class="list-group-item text-center well">
							...
							<?php elseif($result->adjusted_mark < 40): ?>
								<span class="label label-danger" style="margin-left: 10px;"> &nbsp;PASS</span></strong>
							<?php endif; ?>							
						</li>
					</ul>
					<p class="text-right">
